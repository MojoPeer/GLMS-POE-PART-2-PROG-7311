...
namespace GLMS.API.Services
{
    public class ServiceRequestService : IServiceRequestService
    {
        ...
        public ServiceRequestService(ApplicationDbContext db) { _db = db; }

        public async Task<List<ServiceRequest>> GetAllAsync()
            => await _db.ServiceRequests.ToListAsync();
        ...
        public async Task<bool> AddAsync(ServiceRequest request)
        {
            ...
            request.ContractInfo = $"Contract #{contract.Id} - {contract.ServiceLevel}";
